/*
 * Receiver - Testing application properties/JMS filters support with AMQP 1.0 brokers
 */
package test;
...
public class Receiver {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			MessageConsumer messageConsumer = session.createConsumer(address, select);
